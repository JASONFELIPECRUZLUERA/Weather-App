...
const Humidity = () => {
  ...
  const percentage = weatherData.current.humidity !== '' ? weatherData.current.humidity : 84;
  ...
  return (
    <div className='flex justify-center items-center flex-col w-[328px] h-[204px] bg-[#1E213A] gap-3'>
      ...
      <div className='flex justify-center items-center p-1'>
        <span className='text-[64px] font-[700px] leading-[75.14px] text-[#E7E7EB] font-raleway'>{percentage}</span>
