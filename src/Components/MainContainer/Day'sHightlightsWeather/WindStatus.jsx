    ...
    return (
        <div className='flex justify-center items-center flex-col w-[328px] h-[204px] bg-[#1E213A] gap-3'>
            ...
            <div className='flex justify-center items-center p-1'>
                <span className='text-[64px] font-[700px] leading-[75.14px] text-[#E7E7EB] font-raleway'>{weatherData.speed}</span>
                <span className='text-[36px] font-[500px] leading-[42.26px] text-[#E7E7EB] font-raleway'>mph</span>
            </div>

            <div className='flex justify-center items-center p-1'>
                <img className={`w-[29.49px] h-[29.49px] rotate-[${weatherData.deg}deg]`} src='icon-direction.png'></img>
